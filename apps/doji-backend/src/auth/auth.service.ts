...
function deserializeUserReference(ref_str: string, userRepo: EntityRepository<User>): UserReference {
...
export class AuthService {
    ...
    constructor(@Inject('Redis') private readonly  redis: Redis, @InjectRepository(User) private readonly userRepo: EntityRepository<User>) {}
